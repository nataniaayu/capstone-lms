...
const Feedback = () => {
  ...
  const uniqueValues = (key) => {
    return [...new Set(feedbacks.map((feedback) => feedback[key]))];
  };
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex gap-4">
              ...
              >
                ...
                {uniqueValues("users_id").map((userId) => (
              ...
              >
                ...
                {uniqueValues("created_at").map((date) => (
              ...
              <select
                ...
                className="border rounded-lg p-2 text-gray-600"
              >
                <option value="">Filter by Relevansi</option>
                {uniqueValues("relevansi").map((relevansi) => (
                  <option key={relevansi} value={relevansi}>
                    {relevansi}
                  </option>
                ))}
              </select>
