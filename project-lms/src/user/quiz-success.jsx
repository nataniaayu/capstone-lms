...
const QuizSuccess = () => {
  ...
  const score = Math.floor(location.state?.score || 0); // Ensure score is an integer
  const maxScore = Math.floor(location.state?.maxScore || 100); // Ensure maxScore is also an integer
