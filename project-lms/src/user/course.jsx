          ...
          <div className="rounded-lg shadow-md bg-white p-4 flex flex-col h-full">
            ...
            <div className="flex-1 mt-4">
              <div
                ...
                } border border-primary bg-white rounded-md p-4`}
              >
                  ...
                  <>
                    ...
                    {visibleCount < videos.length && (
                      <button
                        ...
                        className="px-4 py-2 text-sm font-medium text-white bg-primary rounded-md shadow-md hover:bg-primary-hover transition"
                      >
                        Show More
                      </button>
                    )}
              ...
              <div className="flex-none flex flex-row mt-4 gap-3">
                <button
  ...
  <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center">
    <div className="bg-white p-6 rounded-lg w-2/3 max-w-3xl">
      ...
      <textarea
        ...
        className="border p-2 w-full h-40 mb-4 resize-none"
      />
